...
const templateBoletoBradescoShopFacil = `
<html>
<head>
...
const boletoFormBradescoShopFacil = `
{{define "boletoForm"}}
<div class="document">
        ...
        <table cellspacing="0" cellpadding="0" border="1">
            ...
            <tr>
                ...
                <td width="30%">
                    ...
                    <br/>
                    <br/>
                    <p class="content right" id="ournumber">
                        {{padLeft (toString16 .View.Boleto.Agreement.Wallet) "0" 2}}
                        / 
